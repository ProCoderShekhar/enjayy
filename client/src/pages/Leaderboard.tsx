            ...
            >
              ...
              >
                ...
                <div className="bg-black/30 rounded-xl overflow-hidden border border-gray-600 shadow-lg p-4 md:p-6 text-center h-full">
                  ...
                  <div className="bg-gradient-to-b from-gray-800 to-black rounded-lg p-0 mb-3 w-full overflow-hidden">
                    <img src="https://i.imgur.com/0ycF4ag.png" alt="Stake Logo" className="w-full min-h-[40px] object-cover" />
                  </div>
              ...
              >
                ...
                <div className="bg-gradient-to-b from-sky-950/50 to-black/70 rounded-xl overflow-hidden border border-sky-700 shadow-xl p-4 md:p-6 text-center">
                  ...
                  <div className="bg-gradient-to-b from-gray-800 to-black rounded-lg p-0 mb-3 w-full overflow-hidden">
                    <img src="https://i.imgur.com/0ycF4ag.png" alt="Stake Logo" className="w-full min-h-[50px] object-cover" />
                  </div>
