            ...
            >
              ...
              >
                ...
                <div className="bg-black/30 rounded-xl overflow-hidden border border-gray-600 shadow-lg p-4 md:p-6 text-center h-full">
                  ...
                  <div className="bg-gradient-to-b from-gray-800 to-black rounded-lg p-2 mb-3 w-full flex items-center justify-center">
                    <div className="py-1 px-2">
                      <img src="https://i.imgur.com/0ycF4ag.png" alt="Stake Logo" className="h-5" />
                    </div>
                  </div>
              ...
              >
                ...
                <div className="bg-gradient-to-b from-sky-950/50 to-black/70 rounded-xl overflow-hidden border border-sky-700 shadow-xl p-4 md:p-6 text-center">
                  ...
                  <div className="bg-gradient-to-b from-gray-800 to-black rounded-lg p-2 mb-3 w-full flex items-center justify-center">
                    <div className="py-1 px-2">
                      <img src="https://i.imgur.com/0ycF4ag.png" alt="Stake Logo" className="h-6" />
                    </div>
                  </div>
